...
resource "azurerm_kubernetes_cluster" "main" {
  ...
  dns_prefix                          = var.private_cluster_enabled ? var.prefix : format("%s-dns", lower(var.name))
  dns_prefix_private_cluster          = var.private_cluster_enabled ? var.prefix_private_cluster : format("%s-dns", lower(var.name))
